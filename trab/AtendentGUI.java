 ...
 * @author Felipe
 */
public class AtendentGUI extends javax.swing.JFrame {
    AtendentChat atendente;
    private Message m = new Message();
    /**
     * Creates new form IChat
     */
    public AtendentGUI() throws RemoteException {
        initComponents();
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        ...
        setToRead(date+" | Atendente > "+m.getMessage());
        try {
            this.atendente.sendMessage(m);
        } catch (RemoteException ex) {
            Logger.getLogger(AtendentGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.toSend.setText("");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new AtendentGUI().setVisible(true);
                } catch (RemoteException ex) {
                    Logger.getLogger(AtendentGUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
